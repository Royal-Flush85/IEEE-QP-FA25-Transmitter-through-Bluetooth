# ESP32 OLED BLE Notification Display (Chronos ESP32)
...
2. Tap **Watches**.
3. Select **Pair new watch**.
4. Choose your ESP32 from the BLE device list.
...
Project and original source code by **Felix Biego**.
Modified or repackaged versions should retain attribution per MIT License.

---

## Notes

* This project is intended for educational, prototyping, and hobby uses.
* Ensure BLE permissions are enabled on your Android device.

---

## Contact

If you'd like help modifying this project or adding features (e.g., animations, battery monitor, custom fonts), feel free to ask!
